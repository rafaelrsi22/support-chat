...
function Alert(props) {
    ...
    return (
        (view) ?
        <div id="alert-additional-content-2" class={"absolute top-5 p-4 mb-4 text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" + (fade ? ' animate-ping' : '')} role="alert">
